...
public class StatisticsStrategy implements AnalysisStrategy {
    ...
    private Map<String, Object> calculateStatistics(Conversation conversation) {
        ...
        // Total message count
        stats.put(StatisticsKeys.TOTAL_MESSAGES, messages.size());
        ...
        stats.put(StatisticsKeys.SENDER_BREAKDOWN, senderCounts);
        ...
        String mostActive = senderCounts.entrySet().stream()
            ...
            .orElse("Unknown");
        stats.put(StatisticsKeys.MOST_ACTIVE, mostActive);
        ...
        double avgLength = messages.stream()
            ...
            .average()
            .orElse(0);
        stats.put(StatisticsKeys.AVG_MESSAGE_LENGTH, Math.round(avgLength));
