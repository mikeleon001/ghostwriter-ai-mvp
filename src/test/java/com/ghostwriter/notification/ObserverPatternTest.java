...
public class ObserverPatternTest {
    ...
    public void setUp() {
        ...
        // Create a test summary using Builder pattern
        ...
        stats.put(StatisticsKeys.TOTAL_MESSAGES, 25);
        stats.put(StatisticsKeys.MOST_ACTIVE, "Alice");

        summary = new Summary.Builder("test-user-id", "test-conversation-id", "2025-12-10")
                .summaryId("test-summary-" + UUID.randomUUID().toString())
                .keyTopics(topics)
                .actionItems(actions)
