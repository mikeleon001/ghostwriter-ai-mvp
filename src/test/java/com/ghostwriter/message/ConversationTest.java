...
public class ConversationTest {
    ...
    public void testAddMultipleMessages() {
        ...
        Message msg1 = new Message(UUID.randomUUID().toString(), "Message 1", "Alice", "2024-12-10 10:00:00");
        Message msg2 = new Message(UUID.randomUUID().toString(), "Message 2", "Bob", "2024-12-10 10:01:00");
        Message msg3 = new Message(UUID.randomUUID().toString(), "Message 3", "Alice", "2024-12-10 10:02:00");
    ...
    public void testMessagesAreOrderedByAddition() {
        ...
        Message msg1 = new Message(UUID.randomUUID().toString(), "First", "Alice", "2024-12-10 10:00:00");
        Message msg2 = new Message(UUID.randomUUID().toString(), "Second", "Bob", "2024-12-10 09:00:00");
        Message msg3 = new Message(UUID.randomUUID().toString(), "Third", "Alice", "2024-12-10 11:00:00");
    ...
    public void testGetMessagesReturnsCorrectList() {
        ...
        Message msg1 = new Message(UUID.randomUUID().toString(), "Test 1", "Alice", "2024-12-10 10:00:00");
        Message msg2 = new Message(UUID.randomUUID().toString(), "Test 2", "Bob", "2024-12-10 10:01:00");
    ...
    public void testMultipleConversationsSameUser() {
        ...
        Message msg1 = new Message(UUID.randomUUID().toString(), "Day 1", "Alice", "2024-12-10 10:00:00");
        Message msg2 = new Message(UUID.randomUUID().toString(), "Day 2", "Bob", "2024-12-11 10:00:00");
