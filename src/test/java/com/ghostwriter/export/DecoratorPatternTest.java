...
public class DecoratorPatternTest {
    ...
    public void setUp() {
        ...
        stats.put(StatisticsKeys.TOTAL_MESSAGES, 30);
        stats.put(StatisticsKeys.MOST_ACTIVE, "Alice");
        stats.put(StatisticsKeys.AVG_MESSAGE_LENGTH, 45);
        
        testSummary = new Summary.Builder("test-user-id", "test-conversation-id", "2025-12-10")
                .summaryId("test-decorator-" + UUID.randomUUID().toString())
                .keyTopics(topics)
                .actionItems(actions)
    ...
    public void testPlainTextFormatterWithEmptyTopics() {
        Summary emptySummary = new Summary.Builder("user-id", "conv-id", "2025-12-10")
                .summaryId("empty-test")
    ...
    public void testHTMLDecoratorEscaping() {
        ...
        Summary specialSummary = new Summary.Builder("user-id", "conv-id", "2025-12-10")
                .summaryId("special-test")
                .keyTopics(topics)
                .actionItems(new ArrayList<>())
                .pendingQuestions(new ArrayList<>())
                .statistics(new HashMap<>())
