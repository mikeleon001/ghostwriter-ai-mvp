...
public class BatchResultTest {
    ...
    /**
     * Creates a mock Summary for testing using Builder pattern.
     */
    private Summary createMockSummary() {
        return new Summary.Builder("test-user", "test-conv", "2025-12-10")
                .summaryId("test-summary-" + System.currentTimeMillis())
                .build();
    }
}
